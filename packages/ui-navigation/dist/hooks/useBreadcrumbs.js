...
export const useBreadcrumbs = (options) => {
    const { items, navigationItems, currentPath, maxItems = 4, showHome = true, homeItem = { id: 'home', label: 'Home', href: '/' }, onItemClick } = options;
    ...
    // 브레드크럼 설정
    const setBreadcrumbs = useCallback((_newItems) => {
        // 직접 관리하는 경우에만 사용 (items prop 사용시)
