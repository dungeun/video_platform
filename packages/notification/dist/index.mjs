...
var NotificationPreferences2 = ({
  ...
  return /* @__PURE__ */ jsx("div", { className: `notification-preferences ${className}`, children: /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxs("div", { children: [
      /* @__PURE__ */ jsx("h3", { className: "text-lg font-semibold mb-4", children: "\uC54C\uB9BC \uCC44\uB110 \uC124\uC815" }),
      /* @__PURE__ */ jsx("div", { className: "space-y-4", children: channels.map((channel) => /* @__PURE__ */ jsxs("div", { className: "border rounded-lg p-4", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-3", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center space-x-3", children: [
            /* @__PURE__ */ jsx("span", { className: "text-2xl", children: channel.icon }),
            /* @__PURE__ */ jsx("span", { className: "font-medium", children: channel.label })
          ] }),
        ...
        preferences.channels[channel.key].enabled && categories.length > 0 && /* @__PURE__ */ jsxs("div", { className: "mt-3 pl-4 space-y-2", children: [
          /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-600 mb-2", children: "\uC54C\uB9BC \uCE74\uD14C\uACE0\uB9AC:" }),
          categories.map((category) => /* @__PURE__ */ jsxs("label", { className: "flex items-center space-x-2 cursor-pointer", children: [
            /* @__PURE__ */ jsx(
              "input",
              {
                type: "checkbox",
            ...
            category.description && /* @__PURE__ */ jsxs("span", { className: "text-xs text-gray-500", children: [
              "(",
    ...
    /* @__PURE__ */ jsxs("div", { className: "border rounded-lg p-4", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-3", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("h3", { className: "font-medium", children: "\uBC29\uD574 \uAE08\uC9C0 \uC2DC\uAC04" }),
          /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-600 mt-1", children: "\uC124\uC815\uB41C \uC2DC\uAC04\uC5D0\uB294 \uC54C\uB9BC\uC744 \uBC1B\uC9C0 \uC54A\uC2B5\uB2C8\uB2E4" })
        ] }),
        /* @__PURE__ */ jsxs("label", { className: "relative inline-flex items-center cursor-pointer", children: [
          /* @__PURE__ */ jsx(
            "input",
      ...
      preferences.quiet.enabled && /* @__PURE__ */ jsxs("div", { className: "flex items-center space-x-4 mt-4", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex-1", children: [
          /* @__PURE__ */ jsx("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: "\uC2DC\uC791 \uC2DC\uAC04" }),
          /* @__PURE__ */ jsx(
            "input",
            {
              type: "time",
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex-1", children: [
          /* @__PURE__ */ jsx("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: "\uC885\uB8CC \uC2DC\uAC04" }),
          /* @__PURE__ */ jsx(
            "input",
            {
              type: "time",
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex justify-end space-x-3", children: [
      saved && /* @__PURE__ */ jsx("span", { className: "text-green-600 flex items-center", children: "\u2713 \uC800\uC7A5\uB418\uC5C8\uC2B5\uB2C8\uB2E4" }),
      /* @__PURE__ */ jsx(
        "button",
        {
          onClick: handleSave,
...
var TemplateEditor = ({
  ...
  const [preview, setPreview] = useState2("");
  const [previewVariables, setPreviewVariables] = useState2({});
  ...
  return /* @__PURE__ */ jsx2("div", { className: `template-editor ${className}`, children: /* @__PURE__ */ jsxs2("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxs2("div", { className: "grid grid-cols-2 gap-4", children: [
      /* @__PURE__ */ jsxs2("div", { children: [
        /* @__PURE__ */ jsx2("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: "\uD15C\uD50C\uB9BF \uC774\uB984 *" }),
        /* @__PURE__ */ jsx2(
          "input",
          {
            type: "text",
        ...
        errors.name && /* @__PURE__ */ jsx2("p", { className: "text-red-500 text-sm mt-1", children: errors.name })
      ] }),
      /* @__PURE__ */ jsxs2("div", { children: [
        /* @__PURE__ */ jsx2("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: "\uC54C\uB9BC \uC720\uD615 *" }),
        /* @__PURE__ */ jsxs2(
          "select",
          {
            className: "w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500",
            ...
            children: [
              /* @__PURE__ */ jsx2("option", { value: "email" /* EMAIL */, children: "\uC774\uBA54\uC77C" }),
              /* @__PURE__ */ jsx2("option", { value: "sms" /* SMS */, children: "SMS" }),
              /* @__PURE__ */ jsx2("option", { value: "push" /* PUSH */, children: "\uD478\uC2DC \uC54C\uB9BC" }),
              /* @__PURE__ */ jsx2("option", { value: "in_app" /* IN_APP */, children: "\uC778\uC571 \uC54C\uB9BC" })
            ]
          }
        )
      ] })
    ...
    /* @__PURE__ */ jsxs2("div", { children: [
      /* @__PURE__ */ jsx2("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: "\uC5B8\uC5B4" }),
      /* @__PURE__ */ jsx2(
        "select",
        {
          className: "w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500",
          ...
          children: languages.map((lang) => /* @__PURE__ */ jsx2("option", { value: lang.code, children: lang.name }, lang.code))
        }
      )
    ] }),
    formData.type === "email" /* EMAIL */ && /* @__PURE__ */ jsxs2("div", { children: [
      /* @__PURE__ */ jsx2("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: "\uC774\uBA54\uC77C \uC81C\uBAA9 *" }),
      /* @__PURE__ */ jsx2(
        "input",
        {
          type: "text",
      ...
      errors.subject && /* @__PURE__ */ jsx2("p", { className: "text-red-500 text-sm mt-1", children: errors.subject })
    ] }),
    /* @__PURE__ */ jsxs2("div", { children: [
      /* @__PURE__ */ jsx2("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: "\uD15C\uD50C\uB9BF \uB0B4\uC6A9 *" }),
      /* @__PURE__ */ jsx2(
        "textarea",
        {
...
\uAC10\uC0AC\uD569\uB2C8\uB2E4.`
      ...
      errors.content && /* @__PURE__ */ jsx2("p", { className: "text-red-500 text-sm mt-1", children: errors.content })
    ] }),
    formData.variables && formData.variables.length > 0 && /* @__PURE__ */ jsxs2("div", { children: [
      /* @__PURE__ */ jsxs2("h4", { className: "text-sm font-medium text-gray-700 mb-2", children: [
        "\uC0AC\uC6A9\uB41C \uBCC0\uC218 (",
        formData.variables.length,
        "\uAC1C)"
      ] }),
      /* @__PURE__ */ jsx2("div", { className: "flex flex-wrap gap-2", children: formData.variables.map((variable) => /* @__PURE__ */ jsx2(
        "span",
        {
    ...
    /* @__PURE__ */ jsxs2("div", { className: "border-t pt-4", children: [
      /* @__PURE__ */ jsxs2("div", { className: "flex justify-between items-center mb-4", children: [
        /* @__PURE__ */ jsx2("h4", { className: "font-medium", children: "\uBBF8\uB9AC\uBCF4\uAE30" }),
        /* @__PURE__ */ jsx2(
          "button",
          {
            type: "button",
      ...
      showPreview && formData.variables && formData.variables.length > 0 && /* @__PURE__ */ jsxs2("div", { className: "space-y-4", children: [
        /* @__PURE__ */ jsxs2("div", { children: [
          /* @__PURE__ */ jsx2("h5", { className: "text-sm font-medium text-gray-700 mb-2", children: "\uBBF8\uB9AC\uBCF4\uAE30 \uBCC0\uC218 \uAC12 \uC124\uC815" }),
          /* @__PURE__ */ jsx2("div", { className: "grid grid-cols-2 gap-2", children: formData.variables.map((variable) => /* @__PURE__ */ jsxs2("div", { className: "flex items-center space-x-2", children: [
            /* @__PURE__ */ jsxs2("label", { className: "text-sm text-gray-600 w-32", children: [
              `{{${variable}}}`,
              ":"
            ] }),
            /* @__PURE__ */ jsx2(
        ...
        /* @__PURE__ */ jsxs2("div", { className: "bg-gray-50 p-4 rounded-md", children: [
          /* @__PURE__ */ jsx2("h5", { className: "text-sm font-medium text-gray-700 mb-2", children: "\uACB0\uACFC" }),
          formData.type === "email" /* EMAIL */ && formData.subject && /* @__PURE__ */ jsxs2("div", { className: "mb-2", children: [
            /* @__PURE__ */ jsx2("span", { className: "text-sm text-gray-600", children: "\uC81C\uBAA9: " }),
            /* @__PURE__ */ jsx2("span", { className: "font-medium", children: formData.subject })
          ] }),
          /* @__PURE__ */ jsx2("div", { className: "whitespace-pre-wrap text-sm", children: preview })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsx2("div", { className: "flex justify-end space-x-3", children: /* @__PURE__ */ jsx2(
      "button",
      {
        type: "button",
        onClick: handleSave,
...
var NotificationHistory = ({
  ...
  const [sortBy, setSortBy] = useState3("sentAt");
  const [sortOrder, setSortOrder] = useState3("desc");
  ...
  const getStatusBadge = (status) => {
    ...
    return /* @__PURE__ */ jsx3("span", { className: `px-2 py-1 text-xs font-medium rounded-full ${config.bg} ${config.text}`, children: config.label });
  };
  ...
  return /* @__PURE__ */ jsxs3("div", { className: `notification-history ${className}`, children: [
    /* @__PURE__ */ jsxs3("div", { className: "mb-6 space-y-4", children: [
      /* @__PURE__ */ jsxs3("div", { className: "flex justify-between items-center", children: [
        /* @__PURE__ */ jsx3("h3", { className: "text-lg font-semibold", children: "\uC54C\uB9BC \uC804\uC1A1 \uB0B4\uC5ED" }),
      ...
      /* @__PURE__ */ jsxs3("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-4", children: [
        /* @__PURE__ */ jsxs3("div", { children: [
          /* @__PURE__ */ jsx3("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: "\uAC80\uC0C9" }),
          /* @__PURE__ */ jsx3(
            "input",
            {
              type: "text",
        ...
        /* @__PURE__ */ jsxs3("div", { children: [
          /* @__PURE__ */ jsx3("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: "\uC54C\uB9BC \uC720\uD615" }),
          /* @__PURE__ */ jsxs3(
            "select",
            {
              className: "w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500",
              ...
              children: [
                /* @__PURE__ */ jsx3("option", { value: "", children: "\uC804\uCCB4" }),
                /* @__PURE__ */ jsx3("option", { value: "email" /* EMAIL */, children: "\uC774\uBA54\uC77C" }),
                /* @__PURE__ */ jsx3("option", { value: "sms" /* SMS */, children: "SMS" }),
                /* @__PURE__ */ jsx3("option", { value: "push" /* PUSH */, children: "\uD478\uC2DC \uC54C\uB9BC" }),
                /* @__PURE__ */ jsx3("option", { value: "in_app" /* IN_APP */, children: "\uC778\uC571 \uC54C\uB9BC" })
              ]
            }
          )
        ] }),
        /* @__PURE__ */ jsxs3("div", { children: [
          /* @__PURE__ */ jsx3("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: "\uC0C1\uD0DC" }),
          /* @__PURE__ */ jsxs3(
            "select",
            {
              className: "w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500",
              ...
              children: [
                /* @__PURE__ */ jsx3("option", { value: "", children: "\uC804\uCCB4" }),
                /* @__PURE__ */ jsx3("option", { value: "pending" /* PENDING */, children: "\uB300\uAE30\uC911" }),
                /* @__PURE__ */ jsx3("option", { value: "queued" /* QUEUED */, children: "\uB300\uAE30\uC5F4" }),
                /* @__PURE__ */ jsx3("option", { value: "sending" /* SENDING */, children: "\uC804\uC1A1\uC911" }),
                /* @__PURE__ */ jsx3("option", { value: "sent" /* SENT */, children: "\uC804\uC1A1\uB428" }),
                /* @__PURE__ */ jsx3("option", { value: "delivered" /* DELIVERED */, children: "\uC804\uB2EC\uB428" }),
                /* @__PURE__ */ jsx3("option", { value: "failed" /* FAILED */, children: "\uC2E4\uD328" }),
                /* @__PURE__ */ jsx3("option", { value: "bounced" /* BOUNCED */, children: "\uBC18\uC1A1" })
              ]
            }
          )
        ] })
    ...
    /* @__PURE__ */ jsx3("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxs3("table", { className: "min-w-full divide-y divide-gray-200", children: [
      /* @__PURE__ */ jsx3("thead", { className: "bg-gray-50", children: /* @__PURE__ */ jsxs3("tr", { children: [
        /* @__PURE__ */ jsx3("th", { className: "px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider", children: "\uC720\uD615" }),
        /* @__PURE__ */ jsx3("th", { className: "px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider", children: "\uC218\uC2E0\uC790" }),
        /* @__PURE__ */ jsxs3(
          "th",
          {
            ...
            children: [
              "\uC0C1\uD0DC",
              sortBy === "status" && /* @__PURE__ */ jsx3("span", { className: "ml-1", children: sortOrder === "asc" ? "\u2191" : "\u2193" })
            ]
          }
        ),
        /* @__PURE__ */ jsxs3(
          "th",
          {
            ...
            children: [
              "\uC804\uC1A1 \uC2DC\uAC04",
              sortBy === "sentAt" && /* @__PURE__ */ jsx3("span", { className: "ml-1", children: sortOrder === "asc" ? "\u2191" : "\u2193" })
            ]
          }
        ),
        /* @__PURE__ */ jsx3("th", { className: "px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider", children: "\uC81C\uACF5\uC790" }),
        /* @__PURE__ */ jsx3("th", { className: "px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider", children: "\uC2DC\uB3C4" }),
        /* @__PURE__ */ jsx3("th", { className: "relative px-6 py-3", children: /* @__PURE__ */ jsx3("span", { className: "sr-only", children: "\uC791\uC5C5" }) })
      ] }) }),
      /* @__PURE__ */ jsx3("tbody", { className: "bg-white divide-y divide-gray-200", children: sortedDeliveries.length === 0 ? /* @__PURE__ */ jsx3("tr", { children: /* @__PURE__ */ jsx3("td", { colSpan: 7, className: "px-6 py-4 text-center text-gray-500", children: "\uC804\uC1A1 \uB0B4\uC5ED\uC774 \uC5C6\uC2B5\uB2C8\uB2E4" }) }) : sortedDeliveries.map((delivery) => /* @__PURE__ */ jsxs3("tr", { className: "hover:bg-gray-50", children: [
        /* @__PURE__ */ jsx3("td", { className: "px-6 py-4 whitespace-nowrap", children: /* @__PURE__ */ jsx3("span", { className: "text-2xl", children: getTypeIcon(delivery.type) }) }),
        /* @__PURE__ */ jsxs3("td", { className: "px-6 py-4 whitespace-nowrap", children: [
          /* @__PURE__ */ jsx3("div", { className: "text-sm text-gray-900", children: delivery.recipient }),
          /* @__PURE__ */ jsx3("div", { className: "text-xs text-gray-500", children: delivery.notificationId })
        ] }),
        /* @__PURE__ */ jsx3("td", { className: "px-6 py-4 whitespace-nowrap", children: getStatusBadge(delivery.status) }),
        /* @__PURE__ */ jsx3("td", { className: "px-6 py-4 whitespace-nowrap text-sm text-gray-900", children: formatDate(delivery.sentAt) }),
        /* @__PURE__ */ jsx3("td", { className: "px-6 py-4 whitespace-nowrap text-sm text-gray-900", children: delivery.provider }),
        /* @__PURE__ */ jsx3("td", { className: "px-6 py-4 whitespace-nowrap text-sm text-gray-900", children: delivery.attempts }),
        /* @__PURE__ */ jsx3("td", { className: "px-6 py-4 whitespace-nowrap text-right text-sm font-medium", children: delivery.status === "failed" /* FAILED */ && onResend && /* @__PURE__ */ jsx3(
          "button",
          {
    ...
    /* @__PURE__ */ jsxs3("div", { className: "mt-4 grid grid-cols-2 md:grid-cols-4 gap-4", children: [
      /* @__PURE__ */ jsxs3("div", { className: "bg-gray-50 p-4 rounded-lg", children: [
        /* @__PURE__ */ jsx3("p", { className: "text-sm text-gray-600", children: "\uC804\uCCB4" }),
        /* @__PURE__ */ jsx3("p", { className: "text-2xl font-semibold", children: deliveries.length })
      ] }),
      /* @__PURE__ */ jsxs3("div", { className: "bg-green-50 p-4 rounded-lg", children: [
        /* @__PURE__ */ jsx3("p", { className: "text-sm text-gray-600", children: "\uC131\uACF5" }),
        /* @__PURE__ */ jsx3("p", { className: "text-2xl font-semibold text-green-600", children: deliveries.filter((d) => d.status === "delivered" /* DELIVERED */).length })
      ] }),
      /* @__PURE__ */ jsxs3("div", { className: "bg-red-50 p-4 rounded-lg", children: [
        /* @__PURE__ */ jsx3("p", { className: "text-sm text-gray-600", children: "\uC2E4\uD328" }),
        /* @__PURE__ */ jsx3("p", { className: "text-2xl font-semibold text-red-600", children: deliveries.filter((d) => d.status === "failed" /* FAILED */ || d.status === "bounced" /* BOUNCED */).length })
      ] }),
      /* @__PURE__ */ jsxs3("div", { className: "bg-blue-50 p-4 rounded-lg", children: [
        /* @__PURE__ */ jsx3("p", { className: "text-sm text-gray-600", children: "\uB300\uAE30\uC911" }),
        /* @__PURE__ */ jsx3("p", { className: "text-2xl font-semibold text-blue-600", children: deliveries.filter((d) => d.status === "pending" /* PENDING */ || d.status === "queued" /* QUEUED */).length })
      ] })
    ] })
  ] });
};
...
var TestSender = ({
  ...
  return /* @__PURE__ */ jsx4("div", { className: `test-sender ${className}`, children: /* @__PURE__ */ jsxs4("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxs4("div", { children: [
      /* @__PURE__ */ jsx4("h3", { className: "text-lg font-semibold mb-4", children: "\uC54C\uB9BC \uD14C\uC2A4\uD2B8 \uC804\uC1A1" }),
      /* @__PURE__ */ jsx4("p", { className: "text-sm text-gray-600 mb-4", children: "\uC54C\uB9BC\uC744 \uD14C\uC2A4\uD2B8\uB85C \uC804\uC1A1\uD558\uC5EC \uD15C\uD50C\uB9BF\uACFC \uC124\uC815\uC744 \uD655\uC778\uD560 \uC218 \uC788\uC2B5\uB2C8\uB2E4." })
    ] }),
    /* @__PURE__ */ jsxs4("div", { children: [
      /* @__PURE__ */ jsx4("label", { className: "block text-sm font-medium text-gray-700 mb-2", children: "\uC54C\uB9BC \uC720\uD615" }),
      /* @__PURE__ */ jsx4("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-2", children: Object.values(NotificationType).map((type) => /* @__PURE__ */ jsxs4(
        "button",
        {
          type: "button",
    ...
    /* @__PURE__ */ jsxs4("div", { children: [
      /* @__PURE__ */ jsx4("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: "\uC218\uC2E0\uC790" }),
      formData.type === "email" /* EMAIL */ && /* @__PURE__ */ jsx4(
        "input",
        {
          type: "email",
          className: "w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500",
      ...
      formData.type === "sms" /* SMS */ && /* @__PURE__ */ jsx4(
        "input",
        {
          type: "tel",
          className: "w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500",
    ...
    /* @__PURE__ */ jsxs4("div", { children: [
      /* @__PURE__ */ jsx4("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: "\uC6B0\uC120\uC21C\uC704" }),
      /* @__PURE__ */ jsxs4(
        "select",
        {
          className: "w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500",
          ...
          children: [
            /* @__PURE__ */ jsx4("option", { value: "low" /* LOW */, children: "\uB0AE\uC74C" }),
            /* @__PURE__ */ jsx4("option", { value: "normal" /* NORMAL */, children: "\uBCF4\uD1B5" }),
            /* @__PURE__ */ jsx4("option", { value: "high" /* HIGH */, children: "\uB192\uC74C" }),
            /* @__PURE__ */ jsx4("option", { value: "urgent" /* URGENT */, children: "\uAE34\uAE09" })
          ]
        }
      )
    ] }),
    /* @__PURE__ */ jsxs4("div", { children: [
      /* @__PURE__ */ jsx4("label", { className: "block text-sm font-medium text-gray-700 mb-2", children: "\uCF58\uD150\uCE20 \uC720\uD615" }),
      /* @__PURE__ */ jsxs4("div", { className: "flex space-x-4", children: [
        /* @__PURE__ */ jsxs4("label", { className: "flex items-center", children: [
          ...
          /* @__PURE__ */ jsx4("span", { className: "text-sm", children: "\uD15C\uD50C\uB9BF \uC0AC\uC6A9" })
        ] }),
        /* @__PURE__ */ jsxs4("label", { className: "flex items-center", children: [
          /* @__PURE__ */ jsx4(
            "input",
          ...
          /* @__PURE__ */ jsx4("span", { className: "text-sm", children: "\uC9C1\uC811 \uC785\uB825" })
        ] })
      ] })
    ] }),
    !formData.customContent && /* @__PURE__ */ jsxs4("div", { children: [
      /* @__PURE__ */ jsx4("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: "\uD15C\uD50C\uB9BF \uC120\uD0DD" }),
      /* @__PURE__ */ jsxs4(
        "select",
        {
          className: "w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500",
          ...
          children: [
            /* @__PURE__ */ jsx4("option", { value: "", children: "\uD15C\uD50C\uB9BF\uC744 \uC120\uD0DD\uD558\uC138\uC694" }),
            templates.filter((t) => t.type === formData.type).map((template) => /* @__PURE__ */ jsx4("option", { value: template.id, children: template.name }, template.id))
          ]
        }
      ),
      selectedTemplate && selectedTemplate.variables.length > 0 && /* @__PURE__ */ jsxs4("div", { className: "mt-4 space-y-2", children: [
        /* @__PURE__ */ jsx4("p", { className: "text-sm font-medium text-gray-700", children: "\uD15C\uD50C\uB9BF \uBCC0\uC218" }),
        selectedTemplate.variables.map((variable) => /* @__PURE__ */ jsxs4("div", { className: "flex items-center space-x-2", children: [
          /* @__PURE__ */ jsxs4("label", { className: "text-sm text-gray-600 w-32", children: [
            `{{${variable}}}`,
            ":"
          ] }),
          /* @__PURE__ */ jsx4(
    ...
    formData.customContent && /* @__PURE__ */ jsxs4("div", { className: "space-y-4", children: [
      formData.type === "email" /* EMAIL */ && /* @__PURE__ */ jsxs4("div", { children: [
        /* @__PURE__ */ jsx4("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: "\uC81C\uBAA9" }),
        /* @__PURE__ */ jsx4(
          "input",
          {
            type: "text",
      ...
      /* @__PURE__ */ jsxs4("div", { children: [
        /* @__PURE__ */ jsx4("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: "\uB0B4\uC6A9" }),
        /* @__PURE__ */ jsx4(
          "textarea",
          {
            className: "w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500",
    ...
    result && /* @__PURE__ */ jsxs4("div", { className: `p-4 rounded-md ${result.success ? "bg-green-50 text-green-800" : "bg-red-50 text-red-800"}`, children: [
      /* @__PURE__ */ jsx4("h4", { className: "font-medium mb-1", children: result.success ? "\uC804\uC1A1 \uC131\uACF5" : "\uC804\uC1A1 \uC2E4\uD328" }),
      result.messageId && /* @__PURE__ */ jsxs4("p", { className: "text-sm", children: [
        "\uBA54\uC2DC\uC9C0 ID: ",
        result.messageId
      ] }),
      result.error && /* @__PURE__ */ jsxs4("p", { className: "text-sm", children: [
        "\uC624\uB958: ",
        result.error
      ] })
    ] }),
...
var useNotification = (options = {}) => {
  ...
  const sendNotification = useCallback(async (request) => {
    setLoading(true);
    setError(null);
    try {
  ...
  const sendBulkNotifications = useCallback(async (requests) => {
    setLoading(true);
    setError(null);
    try {
  ...
  const fetchDeliveries = useCallback(async (filter) => {
    setLoading(true);
    setError(null);
    try {
      const params = new URLSearchParams();
  ...
  const fetchTemplates = useCallback(async (type, language) => {
    setLoading(true);
    setError(null);
    try {
      const params = new URLSearchParams();
  ...
  const resendNotification = useCallback(async (delivery) => {
    setLoading(true);
    setError(null);
    try {
      const response = await fetch(
  ...
  const getDeliveryStats = useCallback(async (startDate, endDate, type) => {
    setLoading(true);
    setError(null);
    try {
      const params = new URLSearchParams({
...
var useNotificationPreferences = ({
  ...
  const [preferences, setPreferences] = useState6(null);
  const [loading, setLoading] = useState6(true);
  const [error, setError] = useState6(null);
  const [saving, setSaving] = useState6(false);
  const fetchPreferences = useCallback2(async () => {
    if (!userId) return;
    setLoading(true);
    setError(null);
    try {
  ...
  const savePreferences = useCallback2(async (newPreferences) => {
    setSaving(true);
    setError(null);
    try {
      const response = await fetch(`${apiUrl}/notifications/preferences/${userId}`, {
  ...
  const toggleChannel = useCallback2((channel) => {
  ...
  const toggleCategory = useCallback2((channel, category) => {
    if (!preferences) return;
  ...
  const toggleQuietHours = useCallback2(() => {
    if (!preferences) return;
    const updated = {
      ...preferences,
      quiet: {
  ...
  const updateQuietHours = useCallback2((start, end) => {
    if (!preferences) return;
    const updated = {
      ...preferences,
      quiet: {
  ...
  const canReceiveNotification = useCallback2((type, category) => {
    if (!preferences) return true;
    const channelKey = type.toLowerCase();
...
var EmailRecipientSchema = z2.object({
  email: z2.string().email("\uC720\uD6A8\uD558\uC9C0 \uC54A\uC740 \uC774\uBA54\uC77C \uC8FC\uC18C\uC785\uB2C8\uB2E4"),
  userId: z2.string().optional(),
  locale: z2.string().optional()
});
var SMSRecipientSchema = z2.object({
  phone: z2.string().refine(validateKoreanPhoneNumber, {
    message: "\uC720\uD6A8\uD558\uC9C0 \uC54A\uC740 \uC804\uD654\uBC88\uD638\uC785\uB2C8\uB2E4"
  }),
  userId: z2.string().optional(),
  locale: z2.string().optional()
});
var NotificationContentSchema = z2.object({
  subject: z2.string().optional(),
  body: z2.string().min(1, "\uBA54\uC2DC\uC9C0 \uBCF8\uBB38\uC774 \uD544\uC694\uD569\uB2C8\uB2E4"),
  html: z2.string().optional()
});
var TemplateVariablesSchema = z2.record(z2.any());
...
export {
  ...
  NotificationHistory,
  NotificationPreferences2 as NotificationPreferencesComponent,
  NotificationPriority,
