...
export type FormFieldType = 'text' | 'email' | 'password' | 'number' | 'tel' | 'url' | 'textarea' | 'select' | 'multiselect' | 'checkbox' | 'radio' | 'date' | 'datetime' | 'time' | 'file' | 'image' | 'color' | 'range' | 'hidden';
...
export type WidgetType = 'chart' | 'table' | 'metric' | 'progress' | 'list' | 'calendar' | 'map' | 'iframe' | 'text' | 'image';
...
export type ChartType = 'line' | 'bar' | 'column' | 'area' | 'pie' | 'donut' | 'scatter' | 'bubble' | 'gauge' | 'funnel' | 'heatmap';
