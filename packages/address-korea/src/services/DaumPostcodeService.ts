...
export class DaumPostcodeService {
  private static instance: DaumPostcodeService;
   ...
   * 주소 검색 팝업 열기
   */
  async openSearch(options?: AddressSearchOptions): Promise<AddressSearchResult> {
   ...
   * 테마 생성
   */
  private createTheme(theme?: DaumPostcodeTheme): any {
    if (!theme) {
