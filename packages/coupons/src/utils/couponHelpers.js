...
export function generateCouponCode(prefix, length = 8) {
...
export function formatCouponCode(code) {
...
export function calculateDiscountedPrice(originalPrice, discountType, discountValue, maxDiscount) {
    let discount = 0;
    switch (discountType) {
        case DiscountType.PERCENTAGE:
...
export function getDaysUntilExpiry(validUntil) {
...
export function formatExpiryText(validUntil) {
...
//# sourceMappingURL=couponHelpers.js.map