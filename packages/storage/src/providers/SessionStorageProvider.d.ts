...
export declare class SessionStorageProvider extends LocalStorageProvider {
     ...
     */
    get<T>(key: string): Promise<import('@repo/core').Result<T | null>>;
    /**
     * 값 저장 - sessionStorage 사용
     */
    set<T>(key: string, value: T, options?: import('../types').StorageOptions): Promise<import('@repo/core').Result<void>>;
    /**
     * 값 삭제 - sessionStorage 사용
     */
    delete(key: string): Promise<import('@repo/core').Result<void>>;
    /**
     * 키 존재 여부 확인 - sessionStorage 사용
     */
    exists(key: string): Promise<import('@repo/core').Result<boolean>>;
    /**
     * 키 목록 조회 - sessionStorage 사용
     */
    keys(query?: import('../types').StorageQuery): Promise<import('@repo/core').Result<string[]>>;
    /**
     * 스토리지 초기화 - sessionStorage 사용
     */
    clear(namespace?: string): Promise<import('@repo/core').Result<void>>;
    /**
     * 스토리지 크기 조회 - sessionStorage 사용
     */
    size(namespace?: string): Promise<import('@repo/core').Result<number>>;
    /**
