...
exports.isValidRRNPrefix = isValidRRNPrefix;
exports.isValidName = isValidName;
exports.isAdult = isAdult;
exports.isValidForeignerNumber = isValidForeignerNumber;
...
function validateForm(data) {
    ...
    // 통신사 인증인 경우 통신사 필수
    if (data.method === types_1.VerificationMethod.MOBILE_CARRIER && !data.carrier) {
 ...
 * 주민등록번호 유효성 검사 (앞자리만)
 */
function isValidRRNPrefix(rrnPrefix) {
 ...
 * 외국인 등록번호 유효성 검사
 */
function isValidForeignerNumber(number) {
    // 13자리 숫자인지 확인
    if (!/^\d{13}$/.test(number)) {
        return false;
    }
