 ...
 * 빈 배열인지 확인
 */
export function isEmpty<T>(arr: T[]): Result<boolean> {
  try {
 ...
 * 배열에 중복 요소가 있는지 확인
 */
export function hasDuplicates<T>(arr: T[]): Result<boolean> {
  try {
    if (!Array.isArray(arr)) {
      return { success: false, error: '입력값이 배열이 아닙니다' };
    }
 ...
 * 배열에서 중복 제거
 */
export function removeDuplicates<T>(arr: T[]): Result<T[]> {
  try {
    if (!Array.isArray(arr)) {
      return { success: false, error: '입력값이 배열이 아닙니다' };
    }
 ...
 */
export function shuffle<T>(arr: T[]): Result<T[]> {
  try {
    if (!Array.isArray(arr)) {
      return { success: false, error: '입력값이 배열이 아닙니다' };
    }
 ...
 * 배열 청크 분할
 */
export function chunk<T>(arr: T[], size: number): Result<T[][]> {
  try {
    if (!Array.isArray(arr)) {
      return { success: false, error: '입력값이 배열이 아닙니다' };
    }
 ...
 * 배열 평탄화
 */
export function flatten<T>(arr: (T | T[])[]): Result<T[]> {
  try {
    if (!Array.isArray(arr)) {
      return { success: false, error: '입력값이 배열이 아닙니다' };
    }
    
    const flattened = arr.flat() as T[];
 ...
 * 깊은 배열 평탄화
 */
export function deepFlatten(arr: any[]): Result<any[]> {
  try {
    if (!Array.isArray(arr)) {
      return { success: false, error: '입력값이 배열이 아닙니다' };
    }
 ...
 * 배열 회전 (왼쪽으로)
 */
export function rotateLeft<T>(arr: T[], positions: number = 1): Result<T[]> {
  try {
    if (!Array.isArray(arr)) {
      return { success: false, error: '입력값이 배열이 아닙니다' };
    }
 ...
 * 배열 회전 (오른쪽으로)
 */
export function rotateRight<T>(arr: T[], positions: number = 1): Result<T[]> {
  try {
    if (!Array.isArray(arr)) {
      return { success: false, error: '입력값이 배열이 아닙니다' };
    }
 ...
 */
export function findIndex<T>(arr: T[], predicate: (item: T, index: number) => boolean): Result<number> {
  try {
    if (!Array.isArray(arr)) {
      return { success: false, error: '입력값이 배열이 아닙니다' };
    }
 ...
 */
export function findLastIndex<T>(arr: T[], predicate: (item: T, index: number) => boolean): Result<number> {
  try {
    if (!Array.isArray(arr)) {
      return { success: false, error: '입력값이 배열이 아닙니다' };
    }
 ...
 * 특정 값의 모든 인덱스 찾기
 */
export function findAllIndexes<T>(arr: T[], value: T): Result<number[]> {
  try {
    if (!Array.isArray(arr)) {
      return { success: false, error: '입력값이 배열이 아닙니다' };
    }
 ...
 * null과 undefined 제거
 */
export function compact<T>(arr: (T | null | undefined)[]): Result<T[]> {
  try {
    if (!Array.isArray(arr)) {
      return { success: false, error: '입력값이 배열이 아닙니다' };
    }
    
    const compacted = arr.filter((item): item is T => item != null);
 ...
 * falsy 값 제거
 */
export function removeFalsy<T>(arr: T[]): Result<T[]> {
  try {
    if (!Array.isArray(arr)) {
      return { success: false, error: '입력값이 배열이 아닙니다' };
    }
 ...
 * 특정 값들 제거
 */
export function removeValues<T>(arr: T[], ...values: T[]): Result<T[]> {
  try {
    if (!Array.isArray(arr)) {
      return { success: false, error: '입력값이 배열이 아닙니다' };
    }
 ...
 * 두 배열의 교집합
 */
export function intersection<T>(arr1: T[], arr2: T[]): Result<T[]> {
  try {
 ...
 * 두 배열의 합집합
 */
export function union<T>(arr1: T[], arr2: T[]): Result<T[]> {
  try {
    if (!Array.isArray(arr1) || !Array.isArray(arr2)) {
      return { success: false, error: '입력값이 배열이 아닙니다' };
    }
 ...
 */
export function difference<T>(arr1: T[], arr2: T[]): Result<T[]> {
  try {
    if (!Array.isArray(arr1) || !Array.isArray(arr2)) {
      return { success: false, error: '입력값이 배열이 아닙니다' };
    }
 ...
 */
export function symmetricDifference<T>(arr1: T[], arr2: T[]): Result<T[]> {
  try {
    if (!Array.isArray(arr1) || !Array.isArray(arr2)) {
      return { success: false, error: '입력값이 배열이 아닙니다' };
    }
 ...
 * 특정 키로 객체 배열 그룹화
 */
export function groupBy<T, K extends keyof T>(arr: T[], key: K): Result<Record<string, T[]>> {
  try {
    if (!Array.isArray(arr)) {
      return { success: false, error: '입력값이 배열이 아닙니다' };
    }
 ...
 * 조건에 따라 배열 분할
 */
export function partition<T>(arr: T[], predicate: (item: T) => boolean): Result<[T[], T[]]> {
  try {
    if (!Array.isArray(arr)) {
      return { success: false, error: '입력값이 배열이 아닙니다' };
    }
 ...
 * 숫자 배열의 합계
 */
export function sum(arr: number[]): Result<number> {
  try {
    if (!Array.isArray(arr)) {
      return { success: false, error: '입력값이 배열이 아닙니다' };
    }
 ...
 * 숫자 배열의 평균
 */
export function average(arr: number[]): Result<number> {
  try {
    if (!Array.isArray(arr)) {
      return { success: false, error: '입력값이 배열이 아닙니다' };
    }
 ...
 * 숫자 배열의 최댓값
 */
export function max(arr: number[]): Result<number> {
  try {
    if (!Array.isArray(arr)) {
      return { success: false, error: '입력값이 배열이 아닙니다' };
    }
 ...
 * 숫자 배열의 최솟값
 */
export function min(arr: number[]): Result<number> {
  try {
    if (!Array.isArray(arr)) {
      return { success: false, error: '입력값이 배열이 아닙니다' };
    }
