 ...
 * MD5 해시 생성
 */
export function md5(data: string): Result<string> {
  try {
 ...
 * SHA-1 해시 생성
 */
export function sha1(data: string): Result<string> {
  try {
 ...
 * SHA-256 해시 생성
 */
export function sha256(data: string): Result<string> {
  try {
 ...
 * SHA-512 해시 생성
 */
export function sha512(data: string): Result<string> {
  try {
 ...
 * HMAC-SHA256 해시 생성
 */
export function hmacSha256(data: string, key: string): Result<string> {
  try {
 ...
 * AES 암호화
 */
export function aesEncrypt(data: string, key: string): Result<string> {
  try {
 ...
 * AES 복호화
 */
export function aesDecrypt(encryptedData: string, key: string): Result<string> {
  try {
 ...
 * Base64 인코딩
 */
export function base64Encode(data: string): Result<string> {
  try {
 ...
 * Base64 디코딩
 */
export function base64Decode(encodedData: string): Result<string> {
  try {
 ...
 * URL-safe Base64 인코딩
 */
export function base64UrlEncode(data: string): Result<string> {
  try {
    const encoded = CryptoJS.enc.Base64.stringify(CryptoJS.enc.Utf8.parse(data))
      .replace(/\+/g, '-')
      .replace(/\//g, '_')
 ...
 * URL-safe Base64 디코딩
 */
export function base64UrlDecode(encodedData: string): Result<string> {
  try {
 ...
 */
export function generateSecureRandomString(length: number = 32): Result<string> {
  try {
    if (length <= 0) {
      return { success: false, error: '길이는 0보다 커야 합니다' };
    }
 ...
 */
export function generateSimpleUuid(): Result<string> {
  try {
 ...
 */
export function hashPassword(password: string, saltRounds: number = 10): Result<string> {
  try {
 ...
 * 보안 토큰 생성
 */
export function generateSecureToken(length: number = 64): Result<string> {
  try {
 ...
 * API 키 생성
 */
export function generateApiKey(prefix: string = 'ak'): Result<string> {
  try {
