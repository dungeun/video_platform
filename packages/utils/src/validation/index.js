 ...
 * 전화번호 형식 검증 (한국)
 */
export function isKoreanPhoneNumber(value) {
    try {
        if (typeof value !== 'string') {
            return { success: true, data: false };
        }
 ...
 * 주민등록번호 형식 검증
 */
export function isKoreanSSN(value) {
    try {
        if (typeof value !== 'string') {
            return { success: true, data: false };
        }
 ...
 * 배열 길이 검증
 */
export function isArrayLength(value, length) {
    try {
        if (!Array.isArray(value)) {
            return { success: true, data: false };
        }
 ...
 * 배열 최소 길이 검증
 */
export function isArrayMinLength(value, minLength) {
    try {
        if (!Array.isArray(value)) {
            return { success: true, data: false };
        }
 ...
 * 배열 최대 길이 검증
 */
export function isArrayMaxLength(value, maxLength) {
    try {
        if (!Array.isArray(value)) {
            return { success: true, data: false };
        }
 ...
 * 문자열 정확한 길이 검증
 */
export function isExactLength(value, length) {
    try {
        if (typeof value !== 'string') {
            return { success: true, data: false };
        }
 ...
 * 정규식 패턴 매치 검증
 */
export function isPattern(value, pattern) {
    try {
        if (typeof value !== 'string') {
            return { success: true, data: false };
        }
 ...
 */
export function validateAny(value, validators) {
    try {
        if (!Array.isArray(validators)) {
            return { success: false, error: '검증자 목록이 배열이 아닙니다' };
        }
