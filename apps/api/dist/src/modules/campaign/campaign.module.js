...
const campaign_adapter_1 = require("./campaign.adapter");
const campaign_service_1 = require("./campaign.service");
const campaign_router_1 = require("./campaign.router");
class CampaignModule {
    ...
    constructor(deps) {
        this.deps = deps;
        this.adapter = new campaign_adapter_1.CampaignModuleAdapter(deps);
        this.service = new campaign_service_1.CampaignService(this.adapter, deps.eventBus);
        this.router = (0, campaign_router_1.createCampaignRouter)(this.service);
    }
    async initialize() {
        if (this.initialized) {
            return;
